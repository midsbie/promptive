 ...
 *  3. `.normalize("NFKD")`: applies Unicode compatibility decomposition,
 *     splitting characters with accents into base letters + combining marks
 *     (e.g. "ó" -> "o" + "◌́")
 *  4. `.replace(/\p{Diacritic}/gu, "")`: removes all combining diacritical
 *     marks (accents, tildes, umlauts, etc.)
 *
 * Example:
 *   "  Canción  " -> "cancion"
 *
